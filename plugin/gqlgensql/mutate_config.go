...
func MutateHook(ggs *GqlGenSqlPlugin) func(b *modelgen.ModelBuild) *modelgen.ModelBuild {
...
func (ggs *GqlGenSqlPlugin) remapInputType2Type(cfg *config.Config) error {
	return nil
}
